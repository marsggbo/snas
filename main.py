...
train_data = dset.CIFAR10(root='../datasets/cifar10',
...
for epoch in range(opt.epochs):
    ...
    train_acc_top1, train_acc_top5, train_valoss, train_poloss = train(
        train_queue, valid_queue, model, criterion, optimizer_arch, optimizer_model, opt.arch_learning_rate, opt.lr_model)
    ...
    f.write("\n")
    print("epoch : ", epoch, "Train_Acc_Top1 : ", train_acc_top1,
          "Train_value_loss : ", train_valoss, "Train_policy : ", train_poloss)
    print("epoch : ", epoch, "Val_Acc_Top1 : ", valid_acc_top1,
          "Val_Acc_Top5 : ", valid_acc_top5, "Loss : ", valid_valoss)
